...
AppController.$inject = ['$scope', '$interval', 'AuthService', 'LightSocket', '$rootScope', '$state'];
function AppController($scope, $interval, AuthService, LightSocket, $rootScope, $state) { // jshint ignore:line
